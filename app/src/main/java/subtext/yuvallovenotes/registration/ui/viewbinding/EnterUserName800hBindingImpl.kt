...
import subtext.yuvallovenotes.databinding.FragmentEnterUserName600hBinding
import subtext.yuvallovenotes.databinding.FragmentEnterUserNameBinding

class EnterUserName600hBindingImpl(val inflater: LayoutInflater, @Nullable val container: ViewGroup?, val attachToRoot: Boolean) : EnterUserNameBinding {

    val binding = FragmentEnterUserName600hBinding.inflate(inflater, container, false)
