...
import subtext.yuvallovenotes.databinding.FragmentEnterLoverPhoneNumber600hBinding

class EnterLoverPhoneNumber600hBindingImpl(val inflater: LayoutInflater, @Nullable val container: ViewGroup?, val attachToRoot: Boolean) : EnterLoverPhoneNumberBinding {

    val binding = FragmentEnterLoverPhoneNumber600hBinding.inflate(inflater, container, false)
